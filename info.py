...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1496229374, 7314923110').split()] # 3567788, 678899, 5889467
...
CHANNEL = environ.get('CHANNEL', 'https://t.me/DM_LinkZzz')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Mkstevebot:CFGVytUlBUTlzkC2@cluster0.8o2rir1.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")

# fsub  information
AUTH_PICS = environ.get('AUTH_PICS', 'https://t.me/DM_LinkZzz')              
AUTH_CHANNEL = (environ.get("AUTH_CHANNEL", "-1002160683630"))
